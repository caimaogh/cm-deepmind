...
class Node(object):
    ...
    def calc_output(self):
        ...
        :return:
        """
        output = reduce(lambda ret, conn: ret + conn.upstream_node.output * conn.weight, self.upstrem, 0)
    ...
    def clac_output_layer_delta(self, label):
        """
    ...
    def __str__(self):
        ...
        :return:
        """
        node_str = '%u-%u: output: %f ' % (self.layer_index, self.node_index, self.output, self.delta)
